...
tags:
  ...
  - slug: pandas
    name: Pandas
cover: https://madhavan11601828.github.io/assets/images/programming-declarative-patterns-cover.png
seo:
  title: 'Declarative Programming Patterns in Python'
  description: 'Use dataclasses, dict dispatch, and Pandas .pipe() to build config-driven ML pipelines in Python.'
