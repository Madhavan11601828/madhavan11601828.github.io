...
tags:
  ...
  - slug: nlp
    name: NLP
cover: https://madhavan11601828.github.io/assets/images/programming-hash-maps-custom-cover.png
seo:
  title: 'Hash Maps: Custom Implementation and Internals'
  description: 'Build a complete HashMap with separate chaining and auto-resize in Python. Understand load factor, collisions, and NLP use cases.'
