...
![Agent Memory Architecture — short-term ConversationBuffer vs long-term Vector Store](https://madhavan11601828.github.io/assets/images/agent-memory-architecture.png)
...
![Agent Execution Loop — how a query flows through the LLM brain, tools, and reflection to produce a final answer](https://madhavan11601828.github.io/assets/images/agent-execution-loop.png)
